...
class Digger():
    ...
    __double_spending_mode_enabled: bool = False
    ...
    def __w_start(self) -> None:
        ...
        while not self.__is_terminated:
            ...
            if transaction_data_obj is not None:
                ...
                self.__logger.info(f"Transaction pool status after popping: {self.__transaction_pool.to_json()}")
    ...
    def add_transaction(self, transaction: Transaction) -> None:
        ...
        self.__logger.info(f"Transaction pool status after transaction adding: {str(self.__transaction_pool.to_json())}")
